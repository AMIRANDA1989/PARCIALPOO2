 ...
 * @author allan
 */
public class HeavyVehicle extends Unit{
    private String Name;

    public HeavyVehicle(String Name, int hitpoints, int attackPoints, int buildTime, int successRate, int rawMaterialsCost, int energyCost, int moneyCost) {
