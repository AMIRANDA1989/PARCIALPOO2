 ...
 * @author allan
 */
public class LightVehicle extends Unit{
    private String Name;

    public LightVehicle(String Name, int hitpoints, int attackPoints, int buildTime, int successRate, int rawMaterialsCost, int energyCost, int moneyCost) {
